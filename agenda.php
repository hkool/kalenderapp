...
<div class="container-fluid">
    ...
    for($i =0;$i<$aantaldagen;$i++){// aantal dagen van het jaar als alternatief
        ...
        do
        {
            ...
            {
                echo "<div class='p-2   today '><a href=\"crudActivity.php?datum=$startY-".($dezemaand+1)."-$dag\">$dag</a></div>";
            }
            else{
                echo "<div class='p-2 days'><a href=\"crudActivity.php?datum=$startY-".($dezemaand+1)."-$dag\">$dag</a></div>";
            }
            $i++;
            $datum = strtotime('+'.$i.' days', $start);
            $maand = intval(date('m', $datum))-1;
